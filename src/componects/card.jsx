...
import BreadcrumbNav from './ContactPages/components/BreadcrumbNav';
            ...
            <div className="d-flex justify-content-between align-items-center mb-4">
              <div>
                ...
                <p className="text-muted ">
                  There are <span style={{ color: '#47c381', fontWeight: 600 }}>{quantities.length}</span> products in your cart
                </p>
              </div>
              <div>
                <button
                  className="btn btn-link text-muted d-flex align-items-center"
                  style={{ textDecoration: 'none', fontWeight: 500, fontSize: '13px' }}
                >
